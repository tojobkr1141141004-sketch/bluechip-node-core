...
drop policy if exists finance_request_events_admin_select on public.finance_request_events;
...
create index if not exists finance_request_events_transaction_idx
